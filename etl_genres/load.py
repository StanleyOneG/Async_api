"""Module for loading genres data to Elasticsearch index."""
...
@dataclass
class ElasticLoader:
    """Class for loading genres data to Elasticsearch index."""
    ...
    @backoff.on_exception(backoff.expo, (ConnectionError, TransportError))
    def load_data(self, genres_data: Generator) -> None:
        """
